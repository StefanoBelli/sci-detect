...
enum scid_genl_attrs {
	...
	SCID_GENL_ATTR_GENIDX,

	SCID_GENL_ATTR_EVT_TYPE,
	SCID_GENL_ATTR_EVT_DATETIME,
	...
	SCID_GENL_ATTR_PAGE_SNAPSHOT_DATETIME,
	SCID_GENL_ATTR_PAGE_SNAPSHOT_SEQ,
	SCID_GENL_ATTR_PAGE_SNAPSHOT_FAULT,
...
enum scid_genl_cmd : unsigned char {
	...
	SCID_GENL_CMD_GET_ONE_LAST_EVENT,
	SCID_GENL_CMD_GET_CUR_PAGE_SNAPSHOT,
